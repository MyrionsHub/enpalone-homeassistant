...
async def async_setup_entry(
    ...
    for table in tables:
        ...
        if measurement == "inverter":
            ...
            elif field == "Current.String.2": addSensor('mdi:lightning-bolt', 'String 2 Current', 'temperature', 'A')
            elif field == "Temperature.Battery": addSensor('mdi:home-thermometer-outline', 'Battery Temperature', 'frequency', '°C')
            elif field == "Frequency.Grid": addSensor('mdi:solar-power-variant', 'Grid Frequency', 'energy', 'Hz')
            elif field == "Inverter.System.State": addSensor('mdi:test-tube-empty', 'Inverter State', 'meter', 'none')
            ...
            elif field == "State.ErrorCodes.9": addSensor('mdi:test-tube-empty', 'Error Code 9', 'battery', 'none')
            ...
            elif field == "Energy.Battery.Charge.Level.Absolute": addSensor('mdi:test-tube-empty', 'Battery Absolute Level', 'power', '%')
            ...
            elif field == "Voltage.String.2": addSensor('mdi:lightning-bolt', '', 'meter2', 'V')
            ...
            if field == "Percent.Storage.Level": addSensor('mdi:battery', 'Battery Level', 'power', '%')
            ...
            elif field == "Power.Storage.Total": addSensor('mdi:battery-charging', 'Battery Power Charging', 'energy', 'W')
            ...
            elif field == "Energy.Storage.Total.Out.Day": addSensor('mdi:battery-arrow-down', 'Total Battery Discharge', '', 'kWh')
            else:
                _LOGGER.debug(f"Not adding measurement: {measurement} field: {field}")

        elif measurement == "iot":
            if field == "Cpu.Load": addSensor('mdi:test-tube-empty', 'CPU Load', 'lte', '%')
