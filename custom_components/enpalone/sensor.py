...
async def async_setup_entry(
    ...
    for table in tables:
        ...
        if measurement == "inverter":
            if field == "Power.DC.Total": addSensor('mdi:solar-power', 'Enpal One - Solar - Production Power', sensortype, unit)
            elif field == "Power.House.Total": addSensor('mdi:home-lightning-bolt', 'Enpal One - Solar - Power House Total', sensortype, unit)
            elif field == "Energy.Production.Total.Day": addSensor('mdi:solar-power-variant', 'Enpal One - Solar - Production Day', sensortype, unit)
            else:
                addSensor('mdi:solar-power', 'Enpal One - Solar -' + field, sensortype, unit) 

        elif measurement == "battery":
            if field == "Power.Battery.Charge.Discharge": addSensor('mdi:battery-charging', 'Enpal One - Battery - Power', sensortype, unit)
            elif field == "Energy.Battery.Charge.Level": addSensor('mdi:battery', 'Enpal One - Battery - Percent', sensortype, unit)
            elif field == "Energy.Battery.Charge.Day": addSensor('mdi:battery-arrow-up', 'Enpal One - Battery - Charge Day', sensortype, unit)
            elif field == "Energy.Battery.Discharge.Day": addSensor('mdi:battery-arrow-down', 'Enpal One - Battery - Discharge Day', sensortype, unit)
            else:
